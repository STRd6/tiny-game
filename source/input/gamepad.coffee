...
#
###* @type {{[key: string]: import("../../types/types").BoundDescriptor<Gamepad>}} ###
gamepadExtensions =
  a: get: -> @buttons[0]?.value # TODO: not sure about these null soaks here
...
Object.defineProperties Gamepad::, gamepadExtensions
